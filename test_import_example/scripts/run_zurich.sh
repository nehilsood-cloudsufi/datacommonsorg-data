#!/bin/bash
# Dataset: Zurich Population (bev_4031_sex_wiki)
# Description: Run Claude agentic import workflow on Zurich demographic data
...
DATASET_NAME="zurich"
SOURCE_DIR="$ROOT_DIR/statvar_imports/zurich/bev_4031_sex_wiki"
OUTPUT_DIR="$ROOT_DIR/test_import_example/$DATASET_NAME"

echo "=========================================="
echo "Running Claude Import: Zurich Population (bev_4031_sex_wiki)"
echo "=========================================="
...
cp "$SOURCE_DIR/test_data/bev_4031_sex_wiki_input.csv" "$OUTPUT_DIR/input/"
cp "$SOURCE_DIR/bev_4031_sex_wiki_pvmap.csv" "$OUTPUT_DIR/input/expected_pvmap.csv"
cp "$SOURCE_DIR/test_data/zurich_bev_4031_sex_wiki_output.csv" "$OUTPUT_DIR/input/expected_output.csv"
cp "$SOURCE_DIR/test_data/zurich_bev_4031_sex_wiki_output.tmcf" "$OUTPUT_DIR/input/expected_output.tmcf"
...
python "$ROOT_DIR/tools/agentic_import/pvmap_generator.py" \
  --input_data="input/bev_4031_sex_wiki_input.csv" \
...
echo ""
echo "=========================================="
echo "[6/6] Results: Zurich Population (bev_4031_sex_wiki)"
echo "=========================================="
