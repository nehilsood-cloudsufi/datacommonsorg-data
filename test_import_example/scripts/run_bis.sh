#!/bin/bash
# Dataset: BIS Central Bank Policy Rate
# Description: Run Claude agentic import workflow on BIS financial data
...
DATASET_NAME="bis"
SOURCE_DIR="$ROOT_DIR/statvar_imports/bis/bis_central_bank_policy_rate"
OUTPUT_DIR="$ROOT_DIR/test_import_example/$DATASET_NAME"

echo "=========================================="
echo "Running Claude Import: BIS Central Bank Policy Rate"
echo "=========================================="
...
cp "$SOURCE_DIR/test_data/WS_CBPOL_csv_flat_input.csv" "$OUTPUT_DIR/input/"
cp "$SOURCE_DIR/central_bank_policy_rate_pvmap.csv" "$OUTPUT_DIR/input/expected_pvmap.csv"
cp "$SOURCE_DIR/test_data/central_bank_policy_rate_output.csv" "$OUTPUT_DIR/input/expected_output.csv"
cp "$SOURCE_DIR/test_data/central_bank_policy_rate_output.tmcf" "$OUTPUT_DIR/input/expected_output.tmcf"
...
python "$ROOT_DIR/tools/agentic_import/pvmap_generator.py" \
  --input_data="input/WS_CBPOL_csv_flat_input.csv" \
...
echo ""
echo "=========================================="
echo "[6/6] Results: BIS Central Bank Policy Rate"
echo "=========================================="
